...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 08, 2019 at 11:21 AM
...
(6, 'male', 'ภูมิ', 'กาญจนบุรี', '#8000ff', 10, '0800213178', '0800213178', 'ข้อความ');
...
--
ALTER TABLE `user`
  MODIFY `suuid` int(4) NOT NULL AUTO_INCREMENT COMMENT 'หมายเลขผู้ใช้', AUTO_INCREMENT=7;
COMMIT;
